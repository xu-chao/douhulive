...
import com.xuchao.douhu.flame.master.flame.danmaku.danmaku.model.IDisplayer;
import com.xuchao.douhu.flame.master.flame.danmaku.danmaku.model.android.DanmakuContext;
import com.xuchao.douhu.flame.master.flame.danmaku.danmaku.parser.BaseDanmakuParser;
...
import com.xuchao.douhu.flame.tv.cjump.jni.DeviceUtils;
...
public class DrawHandler extends Handler {
    ...
    public com.xuchao.douhu.flame.master.flame.danmaku.controller.IDrawTask drawTask;
        ...
        switch (what) {
            ...
            case RESUME:
                ...
                if (mReady) {
                    ...
                    if (drawTask != null) {
                        drawTask.onPlayStateChanged(com.xuchao.douhu.flame.master.flame.danmaku.controller.IDrawTask.PLAY_STATE_PLAYING);
                    }
                } else {
            ...
            case PAUSE:
                ...
                if (drawTask != null) {
                    drawTask.onPlayStateChanged(com.xuchao.douhu.flame.master.flame.danmaku.controller.IDrawTask.PLAY_STATE_PAUSE);
                }
            case QUIT:
                if (what == QUIT) {
...
//                + mCordonTime + ",mFrameRefreshingRate:" + mFrameUpdateRate);
    ...
    private void prepare(final Runnable runnable) {
        if (drawTask == null) {
            drawTask = createDrawTask(mDanmakuView.isDanmakuDrawingCacheEnabled(), timer,
                    ...
                    mDanmakuView.isHardwareAccelerated(), new com.xuchao.douhu.flame.master.flame.danmaku.controller.IDrawTask.TaskListener() {
                        @Override
                        public void ready() {
    ...
    private com.xuchao.douhu.flame.master.flame.danmaku.controller.IDrawTask createDrawTask(boolean useDrwaingCache, DanmakuTimer timer,
                                                                                            Context context,
                                                                                            int width, int height,
                                                                                            boolean isHardwareAccelerated,
                                                                                            com.xuchao.douhu.flame.master.flame.danmaku.controller.IDrawTask.TaskListener taskListener) {
