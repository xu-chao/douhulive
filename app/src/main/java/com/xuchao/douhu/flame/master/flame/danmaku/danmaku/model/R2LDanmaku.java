...
public class R2LDanmaku extends BaseDanmaku {
    ...
    @Override
    public void layout(com.xuchao.douhu.flame.master.flame.danmaku.danmaku.model.IDisplayer displayer, float x, float y) {
        if (mTimer != null) {
    ...
    protected float getAccurateLeft(com.xuchao.douhu.flame.master.flame.danmaku.danmaku.model.IDisplayer displayer, long currTime) {
    ...
    @Override
    public float[] getRectAtTime(com.xuchao.douhu.flame.master.flame.danmaku.danmaku.model.IDisplayer displayer, long time) {
        if (!isMeasured())
            return null;
